...
function transformFileWithSpriteSheetData(file, coordinateMap, pathToSpriteSheetFromCSS,  /*optional*/includeMode, /*optional*/isSilent, /*optional*/outputIndent,/*optional*/matchReg) {
    ...
    if (file.content) {
        ...
        styles = mapOverStylesAndTransformBackgroundImageDeclarations(styles, includeMode, matchReg, function (declaration) {
            ...
            declaration.value = spriterUtil.matchBackgroundImages(declaration.value, function (imagePath) {
                ...
                let coords = coordinateMap[path.join(path.dirname(file.path), imagePath)];
